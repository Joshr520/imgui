...
//#endif
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTexture texture, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col, ImGuiButtonFlags flags = 0);
